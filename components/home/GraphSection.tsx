  ...
  return (
    <div className="bg-white overflow-hidden border border-slate-800 md:rounded md:shadow-sm md:shadow-black">
      ...
      <Collapse in={showGraph}>
        <div className="p-4 relative w-full min-h-[24rem]">{children}</div>
      </Collapse>
    </div>
  );
};
        ...
        <Scatter
          ...
          options={{
            ...
            scales: {
              x: {
                type: "time",
                title: { text: "Time", display: true, color: "black" },
              ...
              y: {
                title: { text: "Magnitude", display: true, color: "black" },
            ...
            plugins: {
              tooltip: {
                ...
                callbacks: {
                  label: (context) => {
                    const entry = context.raw as EarthquakeData;
                    return [
                      `Magnitude: ${entry.properties.mag}`,
                      new Date(entry.properties.time).toLocaleString(),
        ...
        <Bar
          ...
          options={{
            scales: {
              ...
              y: {
                title: { text: "Count", display: true, color: "black" },
            ...
            plugins: {
              tooltip: {
                ...
                callbacks: {
                  title: () => "",
                  label: (context) => {
                    const mag = Math.trunc(context.parsed.x);
                    return [
                      `Magnitude: ${mag} - ${mag + 1}`,
